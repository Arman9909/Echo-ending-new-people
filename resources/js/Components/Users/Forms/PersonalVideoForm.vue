...
<template>
    <div class="container py-4" v-if="self">
        ...
        <div class="text-center mb-4">
            <img src="/аватарка бота.png" alt="мой логотип" style="max-width: 160px"/>
        </div>
...
<!--        &lt;!&ndash; ТАБЫ &ndash;&gt;
        ...
        <form @submit.prevent="submitForm">
            ...
            <template v-if="activeTab === 'form'">
                ...
                <div class="mb-3">
                    <label class="form-label">Жанр произведения</label>
                    <select class="form-select" v-model="form.genre" required>
                        ...
                        <option>Исторический роман</option>
                        <option>Приключения</option>
                        <option>Биография</option>
                        <option>Автобиография</option>
                        <option>Поэзия</option>
                        <option>Сказка</option>
        ...
        required
            ...
            <div class="text-center mt-5 mb-5">
                <button
                    class="btn btn-primary btn-lg px-5 py-4 fw-bold shadow-lg"
                    style="font-size: 1.0rem; border-radius: 50px; min-width: 160px;"
                    @click="openModal"
                >
                    Купить книгу
                </button>
